import { getTranslate, getPlane, getCube } from "./helpers.js";
import { createWalls, createCeiling, createFloor } from "./objects/room.js";
import {
  createWallWoodStrips,
  createCeilingWoodStrips,
} from "./objects/woodStrips.js";

import { createTv, createTvUnit, createRug } from "./objects/furniture.js";
...
const cameraUpdate = () => {
  ...
  if (homeElement) {
    homeElement.style.cssText = `transform-origin: ${-position.x}px ${-position.y}px ${-position.z}px;
      ${getTranslate(
        position.x,
        position.y,
        700,
